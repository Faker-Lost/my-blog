...
export default async function SeriesPage({ params }: SeriesPageProps) {
  const { name } = await params;
  console.log('[DEBUG] name param:', name);
  console.log('[DEBUG] name param (JSON):', JSON.stringify(name));
  console.log('[DEBUG] decoded:', decodeURIComponent(name));
  const allSeries = getAllSeries();
  console.log('[DEBUG] all series slugs:', allSeries.map(s => s.slug));
  const series = getSeriesBySlug(name);
  console.log('[DEBUG] series found:', !!series);
