...
export default function AIStudioPage() {
  ...
  return (
    <div className="flex w-full h-full bg-zinc-50 dark:bg-zinc-950">
      {/* Sidebar */}
      <AISidebar
      ...
      {/* Main Chat Area */}
      <section className="flex-1 h-full relative overflow-hidden bg-zinc-100 dark:bg-gradient-to-br dark:from-zinc-950 dark:to-zinc-900">
