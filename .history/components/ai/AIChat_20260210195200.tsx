            ...
            >
              ...
              <div className={clsx(
                ...
                {m.parts?.some((p: any) => p.type === 'reasoning') && (
                  <div className="mb-4 p-3 rounded-lg bg-zinc-950/50 border border-zinc-800/50 text-xs sm:text-sm text-zinc-400 font-mono leading-relaxed">
                    <div className="flex items-center gap-2 mb-2 text-zinc-500 uppercase tracking-tighter font-bold">
